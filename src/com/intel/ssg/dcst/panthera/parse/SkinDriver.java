...
package com.intel.ssg.dcst.panthera.parse;
...
import com.intel.ssg.dcst.panthera.parse.sql.SqlTextSession;
import com.intel.ssg.dcst.panthera.parse.sql.SqlXlateException;

public class SkinDriver extends Driver {

  static final private Log LOG = LogFactory.getLog(SkinDriver.class.getName());
   ...
   */
  public SkinDriver(HiveConf conf) {
    this.conf = conf;
  }
