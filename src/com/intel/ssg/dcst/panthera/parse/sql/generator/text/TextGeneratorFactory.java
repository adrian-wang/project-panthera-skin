...
import com.intel.ssg.dcst.panthera.parse.sql.PantheraMap;
...
public class TextGeneratorFactory {
  ...
  static {
    ...
    genMap.put(PantheraParser_PLSQLParser.TRIM_VK, new TrimTextGenerator());
    ...
    genMap.put(PantheraParser_PLSQLParser.SQL92_RESERVED_LIKE, new LikeTextGenerator());
