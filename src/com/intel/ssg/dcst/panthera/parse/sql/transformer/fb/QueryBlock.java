...
import com.intel.ssg.dcst.panthera.parse.sql.transformer.fb.processor.FilterBlockProcessorFactory;
...
public class QueryBlock extends BaseFilterBlock {
  ...
  /**
   * build query for transfer, the query only contains FROM and SELECT_LIST branch,
   * if there is aggregation funcs in select list, the aggregation func will be processed (removed or replaced with columns)
   */
