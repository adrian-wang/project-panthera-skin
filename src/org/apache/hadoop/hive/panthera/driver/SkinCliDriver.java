...
package org.apache.hadoop.hive.panthera.driver;
...
public class SkinCliDriver {
  ...
  public int processCmd(String cmd) {
    ...
    if (cmd_trimmed.toLowerCase().equals("quit") || cmd_trimmed.toLowerCase().equals("exit")) {
      ...
      CommandProcessor proc = PantheraProcessorFactory.get(tokens[0], (HiveConf) conf);
  ...
  public static void main(String[] args) throws Exception {
    int ret = new SkinCliDriver().run(args);
    System.exit(ret);
  }
  ...
  private  int executeDriver(CliSessionState ss, HiveConf conf, OptionsProcessor oproc)
    ...
    SkinCliDriver cli = new SkinCliDriver();
